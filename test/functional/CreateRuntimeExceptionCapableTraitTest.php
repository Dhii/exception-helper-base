...
use Dhii\Exception\CreateRuntimeExceptionCapableTrait as TestSubject;
 ...
 * @since [*next-version*]
 */
class CreateRuntimeExceptionCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Exception\CreateRuntimeExceptionCapableTrait';
