...
use Dhii\Exception\CreateInternalExceptionCapableTrait as TestSubject;
 ...
 * @since [*next-version*]
 */
class CreateInternalExceptionCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Exception\CreateInternalExceptionCapableTrait';
